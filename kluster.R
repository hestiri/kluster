...
kluster_sim <- function(data,
  ...
  if (algorithm == 'BIC') {
    ...
    ptime <- c(tBIC,tBIC_kluster/iter_klust,tBIC_kluster/iter_klust)
    ...
    if (algorithm == "PAMK") {
      ...
      ptime <- c(tpamk,tpam_kluster/iter_klust,tpam_kluster/iter_klust)
      ...
      if (algorithm == "CAL") {
        ...
        ptime <- c(tcalinski,tcal_kluster/iter_klust,tcal_kluster/iter_klust)
        ...
        if (algorithm == "AP") {
          ...
          ptime <- c(tap,tap_kluster/iter_klust,tap_kluster/iter_klust)
          ...
          if (algorithm == "Default") {
            ...
            tic()
            calinski.best <- as.numeric(which.max(cascadeKM(data, 3, 15, iter = 500)$results[2,]))
            tcalinski <- toc()
            tcalinski <- as.numeric(tcalinski$toc - tcalinski$tic)
            ...
            ptime <- c(tBIC,tpamk,tcalinski,tap,
                       tBIC_kluster/iter_klust,tcal_kluster/iter_klust,tpam_kluster/iter_klust,tap_kluster/iter_klust,
                       tBIC_kluster/iter_klust,tcal_kluster/iter_klust,tpam_kluster/iter_klust,tap_kluster/iter_klust
            )
...
kluster <- function(data,
  ...
  if (algorithm == 'BIC') {
    ...
    ptime <- c(tBIC_kluster/iter_klust)
